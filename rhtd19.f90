...
! nome file per output ascii
  FULFIASCIIa = OUTDIR(1:lodir) // datehr(n)(1:10) //'_rh_ana.txt'
  FULFIASCIIb = OUTDIR(1:lodir) // datehr(n)(1:10) //'_rh_hdx.txt'
  FULFIASCIIi = OUTDIR(1:lodir) // datehr(n)(1:10) //'_rh_idi.txt'

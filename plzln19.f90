...
! nomi file per output ascii
  FULFIASCIIa = OUTDIR(1:lodir) // datehr(n)(1:10) //'_prec_ana.txt'
  FULFIASCIId = OUTDIR(1:lodir) // datehr(n)(1:10) //'_pidi_dry.txt'
  FULFIASCIIw = OUTDIR(1:lodir) // datehr(n)(1:10) //'_pidi_wet.txt'
